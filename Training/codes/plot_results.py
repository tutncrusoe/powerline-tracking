...
def _main():
    ...
    fname_steer = os.path.join(experiment_rootdir, 'predicted_and_real_steerings.json')
    ...
    make_and_save_histograms(dict_steerings['pred_steerings'], dict_steerings['real_steerings'],
                             os.path.join(experiment_rootdir, "histograms.png"))
    
    # Compute confusion matrix from predicted and real labels
    fname_labels = os.path.join(experiment_rootdir,'predicted_and_real_labels.json')
    ...
    plot_confusion_matrix(dict_labels['real_labels'], dict_labels['pred_probabilities'],
                          ...
                          img_name=os.path.join(experiment_rootdir, "confusion.png"))
